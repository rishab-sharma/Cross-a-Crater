...
* Functions: <testCases >
* Global Variables: <img_rgb , grid_map , rote_path , rote_length , route_array , k  , N_images , grid_map_result>
"""
...
for k in range(1,N_images+1):
        ...
        route_path,route_length,route_array=solveGrid(grid_map)
        #grid_map = drone_m()
        ...
        print route_array
        i=0
        while i+3 < len(route_array):
                cv2.line(img_rgb,(50*route_array[i]+25,50*route_array[i+1]+25),(50*route_array[i+2]+25,50*route_array[i+3]+25),(255,0,0),5)
                i +=2   
